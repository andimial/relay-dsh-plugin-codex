# Codex Validation Run 2026-08-29_0.1.2_ef65b29_live_macos-arm64_txt009
...
- Fresh Sol Codex Session; reasoning effort changes from default Low to High before
  the first message.

## Cases selected

- `cases/CDX-TXT-009--reasoning-effort-selection.md`

## Evidence index

- `evidence/CDX-TXT-009/protocol.md`
- `evidence/CDX-TXT-009/live.md`
- `evidence/CDX-TXT-009/review.md`
- `evidence/CDX-TXT-009/session-events.md`
- `evidence/CDX-TXT-009/default-low.png`
- `evidence/CDX-TXT-009/selected-high.png`
- `evidence/CDX-TXT-009/completed.png`
