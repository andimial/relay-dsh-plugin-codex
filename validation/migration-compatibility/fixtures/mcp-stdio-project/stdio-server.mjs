...
const logPath = process.env.RELAY_MCP_PROJECT_LOG;
...
input.on("line", (line) => {
  ...
  if (message.method === "initialize") {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: "relay-project-stdio-fixture", version: "1.0.0" },
      },
    });
    return;
  }
        ...
        tools: [
          {
            ...
            description: "Return the deterministic project MCP migration oracle.",
            inputSchema: {
              type: "object",
  ...
  if (message.method === "tools/call") {
    ...
    send({
      ...
      result: valid
        ? {
            content: [{ type: "text", text: "STDIO_PROJECT_OK_7731_HZKP" }],
            structuredContent: { transport: "stdio", scope: "project", token },
          }
        : {
            isError: true,
            content: [{ type: "text", text: "PROJECT_STDIO_INVALID_INPUT" }],
          },
    });
    return;
  }
