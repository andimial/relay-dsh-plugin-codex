...
import { LlmAdapter, LlmError, MessageId, ToolCallId, freezeMessage } from "@deepseek-ai/dsh-llm";
...
var CodexDshAdapter = class extends LlmAdapter {
	...
	async *stream(options) {
		...
		const dshToolSurface = codexDshToolSurface(options.tools ?? [], this.dynamicTools);
